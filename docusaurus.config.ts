 ...
 *
 *   DJELIA_OPENAPI=https://api.djelia.cloud/v1/openapi.json npm run gen-api-docs djelia
 *
      ...
      "docusaurus-plugin-openapi-docs",
      {
        ...
        config: {
          djelia: {
            ...
            outputDir: "docs/api",
            downloadUrl: "https://api.djelia.cloud/v1/openapi.json",
            sidebarOptions: {
              groupPathsBy: "tag",
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "OpenAPI spec", href: "https://api.djelia.cloud/v1/openapi.json" },
