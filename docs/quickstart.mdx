...
:::note New API host
Use `https://api.djelia.cloud` for new integrations, as shown below. The old form,
`https://djelia.cloud/api/v1`, remains available until we announce a sunset date.
:::
