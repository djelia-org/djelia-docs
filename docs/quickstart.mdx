...
:::note New API host
Use `https://api.djelia.cloud` for new integrations, as shown below. The old host,
`https://djelia.cloud`, keeps answering during a transition period and will be
announced before it is turned off.
:::
