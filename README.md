...
```bash
DJELIA_OPENAPI=https://api.djelia.cloud/v1/openapi.json npm run build
```
...
```bash
curl -s https://api.djelia.cloud/v1/openapi.json -o openapi/djelia.json
```
...
| Environment | `DJELIA_OPENAPI=https://api.djelia.cloud/v1/openapi.json` |
